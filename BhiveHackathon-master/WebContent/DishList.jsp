...
<!--     <div class="address-bar">26/C, Electronics City, Hosur Road, Electronic City</div>
 ...
 -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a onclick="functionBottom()">Menu</a>
                    </li>
                    <li>
	...
	<div class="row">
            <div class="box">
                <div class="col-lg-12  ">
		<button type="button" class = "btn btn-primary" onclick="func()" style="float:right">Your Kart</button>
			<table class="table table-hover table-striped" bgcolor="#FFFFFF">
			
			<tbody>
				<s:iterator value="dishList">
				<s:url action="loadHotelList" var="hotelList">
						<s:param name="vegId">
      			...
      			<tr>
        			...
        			<td><s:a href="%{hotelList}"><span class="glyphicon glyphicon-chevron-right margintop20"></span> <s:property value="name"/> </s:a></td>
      			</tr>
